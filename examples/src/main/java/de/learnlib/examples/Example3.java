...
public class Example3 {
    ...
    public MealyMachine<?, String, ?, String> runExperiment2() {
        ...
        Supplier<ReuseCapableOracle<BoundedStringQueue, String, String>> supplier = ReuseCapableImpl::new;
    ...
    class ReuseCapableImpl implements ReuseCapableOracle<BoundedStringQueue, String, String> {
        ...
        @Override
        public QueryResult<BoundedStringQueue, String> continueQuery(Word<String> trace,
